...
if __name__ == "__main__":
    ...
    pz_horizon = pd.read_csv(pz_horizon_file, usecols=pz_horizon_cols)
    ...
    pz_pba50 = pd.read_csv(pz_pba50_file, usecols=pz_pba50_cols)
    ...
    # Merge
    merg = pz_horizon.merge(pz_pba50, on="geom_id", how="left")
    ...
    nodev_pba40_1_pba50_0.to_csv(
        os.path.join(PBA50_ZONING_DIR, "nodev_pba40_1_pba50_0.csv")
    )
    ...
    nodev_pba40_0_pba50_1.to_csv(
        os.path.join(PBA50_ZONING_DIR, "nodev_pba40_0_pba50_1.csv")
    )
