...
juris_list = [
    "livermore",
    "hayward",
    "unincorporated_sonoma",
    "fremont",
    "pleasanton",
    "dublin",
    "unincorporated_contra_costa",
    "brentwood",
    "san_ramon",
    "oakley",
    "antioch",
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--area_list", nargs="+", help="list of jurisdiction or county name"
    )
    ...
    for area in args.area_list:
        ...
        print(
            "Export {} records of basezoning for {} to {}".format(
                len(area_basezoning), area, export_file_name
            )
        )
